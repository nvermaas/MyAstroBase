...
python manage.py makemigrations starcharts_app --settings=astrobase.settings.dev --database=stars

python manage.py migrate --settings=astrobase.settings.dev
python manage.py migrate --settings=astrobase.settings.dev --database=stars