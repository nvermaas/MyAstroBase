...
astrobase_service -o submit --interval 30 --astrobase_host http://192.168.178.62:8018/astrobase --local_landing_pad ~/www/astrobase/landing_pad --local_data_dir ~/www/astrobase/data --local_data_url http://uilennest.net/astrobase/data -v &
